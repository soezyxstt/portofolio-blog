...
const ProjectCard = ({
  ...
  const isInView = useInView<HTMLDivElement>(ref, { threshold: 1 });

  return (
    <div
      ref={ref}
      className={cn(
        `bg-cover bg-center peer transition-all duration-200 md:delay-200 relative group md:grayscale-[80%] md:hover:grayscale-0 cursor-pointer snap-center`,
        bg,
        w,
        isInView ? 'grayscale-0' : 'grayscale-[80%]',
        className
      )}
    >
